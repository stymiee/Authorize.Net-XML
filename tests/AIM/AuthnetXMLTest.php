<?php
    ...
    class AuthnetXMLTest extends PHPUnit_Framework_Testcase {
        public function testAuthCapture() {
            ...
            $this->assertEquals('Ok', $xml->messages->resultCode);
            $this->assertEquals('I00001', $xml->messages->message->code);
            $this->assertTrue($xml->isSuccessful());
            $this->assertFalse($xml->isError());
        }
